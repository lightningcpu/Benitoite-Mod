package net.lightningmines.mod;

import com.mojang.logging.LogUtils;
import net.lightningmines.mod.block.ModBlocks;
import net.lightningmines.mod.item.ModCreativeModeTabs;
...
@Mod(BenitoiteMod.MOD_ID)
public class BenitoiteMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "benitoitemod";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            ...
            event.accept(ModItems.RAW_BENITOITE);
        }
